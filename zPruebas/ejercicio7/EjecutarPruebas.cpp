...
int main() {
    ...
    "4.in.txt","10.in.txt","100.in.txt","1000.in.txt",
    "10000.in.txt","100000.in.txt","1000000.in.txt"
};

vector<string> outputFiles = {
    "4.out.txt","10.out.txt","100.out.txt","1000.out.txt",
    "10000.out.txt","100000.out.txt","1000000.out.txt"
};

vector<string> generatedFiles = {
    "4.myOut.txt","10.myOut.txt","100.myOut.txt","1000.myOut.txt",
    ...
    for (size_t i = 0; i < inputFiles.size(); ++i) {
        ...
        string command = "ejercicio7.exe < " + inputFilePath + " > " + generatedFilePath;
