...
int main() {
    ...
    for (size_t i = 0; i < inputFiles.size(); ++i) {
        ...
        string command = "ejercicio6.exe < " + inputFilePath + " > " + generatedFilePath;
